...
resource_mining_speed={} # стандарнтний час збільшення ресурсів (без враховування будівль)
import json
#options={"volume":0.5}
...
class Game(Screen): # ігровий клас
    ...
    def __init__(self): # конструктор класу
        ...
        self.people_button_text=Button(size_hint=[1,0.1],text="54540 (+5)",background_normal="", background_down="",color=[1,0,1,1],background_color=[0,0,0,1])
